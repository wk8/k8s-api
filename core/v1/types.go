...
type PodSecurityContext struct {
	...
	// +optional
	WindowsOptions *WindowsSecurityOptions `json:"windowsOptions,omitempty" protobuf:"bytes,8,opt,name=windowsOptions"`
...
type SecurityContext struct {
	...
	// Windows security options.
	// +optional
	WindowsOptions *WindowsSecurityOptions `json:"windowsOptions,omitempty" protobuf:"bytes,10,opt,name=windowsOptions"`
	// The UID to run the entrypoint of the container process.
	// Defaults to user specified in image metadata if unspecified.
